...
FROM
    ...
    LEFT JOIN C_SETOR S ON C.COD_UNID = S.COD_UNID AND CU.COD_SET = S.COD_SET
    ...
    INNER JOIN (
        SELECT CONTAC, MAX(DATA) AS MAX_DATA FROM CC_MVCLOS WHERE COD_LANC = 4015 AND COMPENSADO = 'T' GROUP BY CONTAC
